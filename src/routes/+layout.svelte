...
<!-- Footer -->
<footer class="footer">
    <div class="border-t border-[#FFA808]"></div>

    <div
        class="footer-content max-w-6xl mx-auto px-6 py-10 flex flex-col md:flex-row gap-8 md:gap-16">
        <div class="footer-section flex-1">
            <h5 class="text-xl font-bold mb-2 text-[#FFA808]">TriDee</h5>
            <p class="text-sm">
                Temukan aset 3D berkualitas tinggi untuk proyek kreatif Anda.
            </p>
        </div>
        ...
        <div class="footer-section flex-1">
            ...
            <ul class="space-y-1">
                <li>
                    <a 
                        href="/" 
                        class="hover:text-[#FFA808] transition">Home</a>
                </li>
                <li>
                    <a
                        href="/marketplace"
                        class="hover:text-[#FFA808] transition">Marketplace</a>
                </li>
                <li>
                    <a 
                        href="/user" 
                        class="hover:text-[#FFA808] transition">Profile</a>
                </li>
                <li>
                    <a
                        href="/user/login"
                        class="hover:text-[#FFA808] transition">Login</a>
                </li>
                <li>
                    <a
                        href="/user/register"
                        class="hover:text-[#FFA808] transition">Register</a>
                </li>
            </ul>
        </div>

        <div class="footer-section flex-1">
            <h5 class="text-lg font-semibold mb-2 text-[#FFA808]">
                Kategori Populer
            </h5>
            <ul class="space-y-1">
                <!-- ubah nanti -->
                <li>
                    <a
                        href="/search?s=character"
                        class="hover:text-[#FFA808] transition">Character</a>
                </li>
                <li>
                    <a
                        href="/search?s=vehicle"
                        class="hover:text-[#FFA808] transition">Vehicle</a>
                </li>
                <li>
                    <a
                        href="/search?s=environment"
                        class="hover:text-[#FFA808] transition">Environment</a>
                </li>
                <li>
                    <a
                        href="/search?s=tools"
                        class="hover:text-[#FFA808] transition">Tools</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div
        class="footer-bottom text-center py-4 border-t border-[#FFA808] text-gray-400 text-sm">
        © 2025 ThriDee
    </div>
</footer>
